...
<body>
    <div class="widget container d-flex">
        <div class="left-column">
            <a href="<?php echo $logo_url; ?>" target="_blank"><img class="widgetLogo" src="<?php echo base_url('assets/logo/'.$this->optionslib->get_logo('header_logo', $theme).'.png'); ?>" alt="Logo" /></a>
        </div>
